...
class visualizer(VisualizerAbstractClass):
    def __init__(self, ref_data_provider, data_provider, R, train_representation, projector, bg, resolution, indicates, cmap='tab10'):
    ...
    def get_epoch_plot_measures(self, epoch):
        ...
        # data = self.ref_data_provider.train_representation(epoch)
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        np_grid_samples = np.asarray(self.bg)
