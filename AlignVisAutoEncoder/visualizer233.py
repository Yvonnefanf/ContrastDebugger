...
class visualizer(VisualizerAbstractClass):
    def __init__(self, data_provider, autoencoder_for_2d, ref_provider, autoencoder, train_representation, projector, resolution, indicates, cmap='tab10'):
        ...
        self.autoencoder_for_2d = autoencoder_for_2d
    ...
    def get_epoch_plot_measures(self, epoch):
        ...
        data = self.ref_provider.train_representation(epoch)
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        grid = self.projector.batch_project(epoch, self.train_representation)[:40000]

        # map gridmpoint o images
        ...
        new_grid = self.autoencoder.decoder(self.autoencoder.encoder(self.autoencoder.decoder(torch.Tensor(np_grid_samples))))
    ...
    def savefig(self, epoch, path="vis"):
        ...
        embedding = self.projector.batch_project(epoch, after_trans)
