...
class visualizer(VisualizerAbstractClass):
    def __init__(self, data_provider, tar_provider, train_representation, projector, autoencoder,resolution, indicates,cmap='tab10'):
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        mesh_preds = self.tar_provider.get_pred(epoch, new_grid)
