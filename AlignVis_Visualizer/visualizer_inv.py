...
class visualizer(VisualizerAbstractClass):
    def __init__(self, data_provider, ref_provider, autoencoder, train_representation, projector, resolution, indicates, cmap='tab10'):
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        new_grid = self.autoencoder.encoder(torch.Tensor(np_grid_samples))
