...
class visualizer(VisualizerAbstractClass):
    def __init__(self, data_provider, R, RT_V, train_representation, projector, tar_projector, resolution, indicates, cmap='tab10'):
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        grid_samples = self.tar_projector.batch_inverse(epoch, grid)
