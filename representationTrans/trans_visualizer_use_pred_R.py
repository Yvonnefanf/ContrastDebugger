...
class visualizer(VisualizerAbstractClass):
    def __init__(self, data_provider, R, pred_R, train_representation, projector, resolution, indicates, cmap='tab10'):
    ...
    def get_epoch_decision_view(self, epoch, resolution):
        ...
        temp_preds = self.data_provider.get_pred(epoch, new_grid)
