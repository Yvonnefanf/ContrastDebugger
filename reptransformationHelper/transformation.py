...
NOISY20 = "/home/yifan/dataset/noisy/pairflip/cifar10/noisy500/"
...
vis.savefig(200, path=os.path.join(save_dir, "Xi_1211"))
...
vis.savefig(200, path=os.path.join(save_dir, "Xj_1211"))
...
vis.savefig(200, path=os.path.join(save_dir, "XjR_1211"))
...
import os
import numpy as np
clean_path = os.path.join(NOISY20, 'clean_label.json')
with open(clean_path, "r") as f:
    clean_labels = np.array(json.load(f))
noisy_path = os.path.join(NOISY20, 'noisy_label.json')
...
print(noisy_indicates)


from representationTrans.r_visualizer import visualizer
# print(R)
vis_r = visualizer(ref_provider, train_data, projector, noisy_indicates, 200, 'tab10')
save_dir = os.path.join('/home/yifan/projects' , "imgcontrast")
# os.makedirs(save_dir)

vis_r.savefig(200, path=os.path.join(save_dir, "Xi_noisyonly"))


# print(R)
vis_r = visualizer(ref_provider, np.dot(noisy_data,R), projector, noisy_indicates, 200, 'tab10')
save_dir = os.path.join('/home/yifan/projects' , "imgcontrast")
# os.makedirs(save_dir)

vis_r.savefig(200, path=os.path.join(save_dir, "XjR_noisyonly"))
